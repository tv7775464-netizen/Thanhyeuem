...
imageButton.Image = "rbxassetid://122325089010707"
...
Status:AddDiscordInvite({
    Name = "Cho tao Oppo K15 Turbo Pro ik",
    Description = "join for support and update <3",
    Logo = "rbxassetid://122325089010707",
    Invite = "hoặc turbo 5 Pro á"
})
